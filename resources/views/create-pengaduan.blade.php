        ...
        <div class="page-content" style="min-height:50vh!important">
            ...
            <div class="card card-style" style="height: 100%;">
                <div class="content mb-0 p-2" style="height: 100%;">
                    <form action="{{ route('tambah-pengaduan.store') }}" method="POST">
                    @csrf
                        <div class="row mb-0">
                            <div class="col-12">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 justify-content-center text-center align-item-center">
                                <button type="submit" class="btn bg-active btn-block">Kirim</button>
                            </div>
                        </div>
                    </form>
                </div>
